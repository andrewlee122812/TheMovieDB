...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    public void addContact(Movie movie) {
        ...
        values.put(KEY_NAME, movie.getOriginal_title());  //0
    ...
    public Movie getMovie(int id) {
        ...
        Movie movie = new Movie(String.valueOf(cursor.getInt(1)),
    ...
    public List<Movie> getAllContacts() {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                contact.setMovieID(String.valueOf(cursor.getInt(1)));
                contact.setOriginal_title(cursor.getString(0));
